...
# Oracle credentials
    ...
    4. Create a private_key.pem file in the root directory with your Oracle private key:
        ...
        ## Below are the steps to Authenticate API call for Oracle Application Using Mulesoft
        ...
        ## Windows User Command
            ...
            **Details of Certificate**
            ...
            ## Apple Mac Book User Command 

            - **Note** : Ensure your terminal is in  same folder when running below command so that all files are generated in same location
...
- Method: GET
- edirects: To Zoom chat with the bot
...
##  Zoom's Incoming Webhook Chatbot
       ...
       **How to send messages to Zoom Team Chat**
       ...
       You can schdule your POST requests to be sent at a specific time using a tool like AWS Events based on  AWS Lambda or Cron or any other tool. You can schedule your requests based on Json formatted data. (refer the example in code)
